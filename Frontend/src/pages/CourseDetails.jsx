...
const CourseDetails = () => {
  ...
  const isEnrolled =
    user?.role === "Student" &&
    studentEnrollments.some((enrollment) => enrollment.courseId?._id === id);
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          An experienced professional with over 10 years in the
                          industry. Passionate about teaching and helping
